            ...
            <form method="post" action="{{ route('login-acesso') }}">
              ...
              <div class="mb-md-5 mt-md-4 pb-5">
                ...
                <div class="d-flex justify-content-center text-center mt-4 pt-1">
                  ...
                  <a href="https://twitter.com/" class="text-white"><i class="fab fa-twitter fa-lg mx-4 px-2"></i></a>
                  <a href="https://accounts.google.com/" class="text-white"><i class="fab fa-google fa-lg"></i></a>
                </div>
              </div>

              <div>
                <p class="mb-0">Não possui uma conta? <a href="/signup" class="text-white-50 fw-bold">Cadastrar</a></p>
              </div>
            </form>
          </div>
        </div>
